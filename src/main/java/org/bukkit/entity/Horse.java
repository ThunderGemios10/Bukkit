...
public interface Horse extends Animals, Vehicle, InventoryHolder, Tameable {
     ...
     * <p>
     * Setting a horse's variant does not change its other attributes,
     * such as its owner, tamed status, inventory, etc.
     *
     ...
     * Only donkeys and mules can carry a chest.
     *
     ...
     * <p>
     * You cannot add a chest to a horse which cannot carry it.
     * Only donkeys and mules are capable of having a chest. Attempting
     * to set this value to true for any other variant will not affect it.
     * <p>
     * Removing a chest from a donkey or mule that is already carrying one
     * will also clear the chests inventory.
     *
